...
module.exports.run = async (client, message, args) => {
  ...
  // Database Entry
  //
  let sql = `INSERT INTO discordpunishments (punisheduser, punisher, punishtype, reason) VALUES ('${user.user.username}', '${message.author.username}', 'WARN', '${reason}')`;
  ...
  console.log(chalk.yellow('[CONSOLE] ' ) + chalk.blue('[DISCORD] ') + `${message.author.username} has warned ${user.user.username} for ${reason}.`);
  return;
};
